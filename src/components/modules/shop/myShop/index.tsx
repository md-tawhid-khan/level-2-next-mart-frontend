...
const MyShop = async({myshop}:any) => {
    ...
    return (
        <div>
            {
              myshop?<div className='flex flex-col h-screen justify-center items-center gap-4 '>
        ...
        </div> : <div className='min-h-screen flex justify-center items-center'><h1 className='text-3xl text-blue-300'>you have no shop</h1></div>
            }
